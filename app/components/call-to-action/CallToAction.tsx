...
export default function CallToAction() {
  ...
  // Fondo red neuronal interactiva con ondas
  useEffect(() => {
    ...
    const points = Array.from({ length: 40 }, () => ({
      ...
      pulse: 0,
      wave: 0 // NUEVO: tiempo de onda en progreso
    }));
    ...
    <section className="cta-section">
      ...
      <div className="cta-content">
        ...
        <p className="cta-text">
          En Brecomperu IT Solutions convertimos ideas en realidades inteligentes.
          Da el siguiente paso hacia el futuro.
        </p>
        <div className="cta-buttons">
          <a href="#contacto" className="cta-btn-primary">Agenda tu reunión</a>
